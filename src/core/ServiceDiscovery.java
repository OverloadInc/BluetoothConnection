...
/**
 * The ServiceDiscovery class allows users sending files to a specific Bluetooth
 * device selected from a list.
 * This class implements the DiscoveryListener class methods for device and
 * service discovery and provides its own methods for selecting and sending

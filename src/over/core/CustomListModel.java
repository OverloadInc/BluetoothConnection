...
/**
 * The <code>CustomListModel</code> class provides a means for Bluetooth device
 * management. This class contains methods for adding, deleting and obtaining 
 * information related to Bluetooth devices which are detected by a service 
 * discovery mechanism. In addition, the <code>CustomListModel</code> is 
 * responsible for building a list model to display all the information obtained
 * by the service discovery mechanism such that the user selects a specific device
 * for sending files easily.
 * 
 * @author Overload Inc.
